...
Compiler.prototype.isConfigFile = function(file) {
    ...
    if (!utils.isFunction(isConfigFile)) { isConfigFile = Compiler.isConfigFile; }
...
Compiler.prototype.isConfigObject = function(config) {
    ...
    if (!utils.isFunction(isConfigObject)) { isConfigObject = Compiler.isConfigObject; }
